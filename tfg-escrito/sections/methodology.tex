...
\textcolor{red}{Furthermore, this dynamic trigger is shown to be optimal and more precise than others relying on fixed values e.g. enter position when spread is greater than 2 standard deviations}  
